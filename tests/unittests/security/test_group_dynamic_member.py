...
class SecurityGroupDynamicMemberTest(unittest.TestCase):

    def setUp(self):
        super(SecurityGroupDynamicMemberTest, self).setUp()
        self._regen_ctx()
    ...
    def tearDown(self):
        current_ctx.clear()
        super(SecurityGroupDynamicMemberTest, self).tearDown()
